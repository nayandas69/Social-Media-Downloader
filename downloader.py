...
def download_youtube_or_tiktok_video(url):
    ...
    try:
        ...
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            print(f"\n\033[1;32mDownloaded successfully with audio:\033[0m {title}")
...
# ---------------------------------
def batch_download_instagram(urls):
    """Download Instagram posts concurrently."""
    print("Starting Instagram batch download...")
    ...
    try:
        ...
        while True:
            ...
            if choice == "1":
                ...
                urls = input("Enter Instagram URLs separated by spaces: ").split()
                batch_download_instagram(urls)
            elif choice == "5":
                check_for_updates()
            elif choice == "6":
                show_help()
